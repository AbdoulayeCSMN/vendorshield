...
export const SUPPLIER_FIELDS: ImportField[] = [
  ...
  { key: 'contract_start_date', label: 'Début de contrat (AAAA-MM-JJ)' },
  { key: 'contract_end_date', label: 'Fin de contrat (AAAA-MM-JJ)' },
  { key: 'payment_terms_days', label: 'Délai de paiement (jours)' },
